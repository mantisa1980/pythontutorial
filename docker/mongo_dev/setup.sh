...
read dummy
docker-compose exec pig-mongo-001-test mongo --port 27018 /hostdata/init_cluster1shard1.js # init replica set 0
docker-compose exec mongo-cluster1-cfgsvr1 mongo --port 27019 /hostdata/init_cluster1_cfgsvr.js # init config server
